function buildFormula1Metadata(year = 2010) {
    // Build a metadata for Formula 1 2010 by default
    ...
    d3.json(`/data/${year}`).then(function (data) {
        Object.entries(data).forEach((key) => {
            console.log(key)
            console.log(data)
            sample_metadata.append('p')
                
                .text(data['names'] + ": " + data['points'] + "\n");
        });
    });
}
